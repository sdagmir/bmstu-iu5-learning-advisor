...
| 3 | POST | `/auth/refresh` | public | 200 |
| 4 | POST | `/auth/logout` | public | 204 |
| 5 | GET | `/users/me` | user | 200 |
| 6 | PATCH | `/users/me` | user | 200 |
| 7 | GET | `/users/me/workload` | user | 200 |
| 8 | GET | `/users/me/completed-ck` | user | 200 |
| 9 | POST | `/users/me/completed-ck` | user | 201 |
| 10 | DELETE | `/users/me/completed-ck/{id}` | user | 204 |
| 11 | GET | `/users/me/grades` | user | 200 |
| 12 | PUT | `/users/me/grades` | user | 200 |
| 13 | GET | `/catalog/disciplines` | user | 200 |
| 14 | GET | `/catalog/ck-courses` | user | 200 |
| 15 | GET | `/expert/my-recommendations` | user | 200 |
| 16 | POST | `/expert/evaluate` | user | 200 |
| 17 | POST | `/expert/evaluate/debug` | admin | 200 |
| 18 | POST | `/chat/message` | user | 200 |
| 19 | POST | `/chat/message/debug` | admin | 200 |
| 20 | POST | `/rag/search` | user | 200 |
| 21 | POST | `/rag/documents` | admin | 201 |
| 22 | DELETE | `/rag/documents/{source}` | admin | 204 |
| 23 | GET | `/rag/stats` | admin | 200 |
| 24-26 | RU | `/admin/users` | admin | -- |
| 27-30 | CRUD | `/admin/competencies` | admin | -- |
| 31-34 | CRUD | `/admin/disciplines` | admin | -- |
| 35-38 | CRUD | `/admin/ck-courses` | admin | -- |
| 39-42 | CRUD | `/admin/career-directions` | admin | -- |
| 43-46 | CRUD | `/admin/focus-advices` | admin | -- |
| 47-50 | CRUD | `/admin/rules` | admin | -- |

**Итого: 50 эндпоинтов** (4 public, 15 user, 31 admin)
